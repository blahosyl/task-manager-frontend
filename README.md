...
- [UX/UI](#uxui)
  * [Strategy](#strategy)
    + [The polarity of project execution](#the-polarity-of-project-execution)
    + [Conservative design of productivity apps](#conservative-design-of-productivity-apps)
    + [Cumbersome filtering](#cumbersome-filtering)
  * [Scope: holistic productivity](#scope-holistic-productivity)
    + [Bold colors carrying meaning](#bold-colors-carrying-meaning)
    + [Playful indications of overdue tasks](#playful-indications-of-overdue-tasks)
    + [Easy filtering at a click](#easy-filtering-at-a-click)
  * [Structure](#structure)
  ...
  * [Skeleton](#skeleton)
    ...
    + [Task create/edit wireframe](#task-createedit-wireframe)
  * [Surface](#surface)
    + [App name](#app-name)
    ...
    + [UX Improvements](#ux-improvements)
      ...
      - [Explicit confirmation after user CRUD actions](#explicit-confirmation-after-user-crud-actions)
